...
function changeTabs() {
  const tabButton = document.querySelector('.board-option-button');
  const entireBoard = document.querySelector('.board-results');
  const annBoard = document.querySelector('.announcements');
  const refBoard = document.querySelector('.references');



  if(boardNumber == 1) {
    refBoard.style.display="none";
    annBoard.style.display="block";
  } else if (boardNumber == 2) {
    annBoard.style.display="none";
    refBoard.style.display="block";
  }
